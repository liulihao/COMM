...
$.getJSON('data/comm.geojson', function(data) {
  ...
  $("#about-btn").click(function() {
	...
	//		alert("No Record!");
	//}},1000);
	//alert(felonyavg*safetyweight);
	//alert(safety);
	//alert(price_to);
	//alert("Second: " + felonyrecord + "," + felonysum);
  });
  ...
  function mouseoverFunction(e) {
    ...
    $('#side').html('<h3>' + layer.feature.properties.Location + ' ' + '</h3>' + '<h4>' + '<b>' + (layer.feature.properties.vacancy*100).toFixed(2) + '%</b>' + ' of Units Available for Rent' + '</h4>');
  	}
